...
from backend.models import Shop, Category, ProductInfo, Product, Parameter, ProductParameter, OrderItem, Order
from backend.services import upload_partner_data
from backend.tasks import celery_upload_partner_data

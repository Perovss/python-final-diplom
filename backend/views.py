...
from backend.responses import ResponseOK, ResponseNotFound, ResponseBadRequest
from backend.serializers import ShopDetailSerializer, ShopSerializer, CategorySerializer, \
...
from backend.services import upload_partner_data, validate_url
from backend.tasks import send_mail_order_accepted, celery_upload_partner_data
